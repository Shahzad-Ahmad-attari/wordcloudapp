...
if uploaded_file:
    ...
    st.sidebar.markdown("---")
    st.sidebar.subheader("Subscribe to our Youtube Channel to learn islamic information.")
    # add a youtube video
    st.sidebar.video("https://www.youtube.com/watch?v=ixWzzBismL4")
    st.sidebar.markdown("---")
    # add author name and info
    st.sidebar.markdown("Created by: [Editera.com.pk](https://editera.com.pk/)")
    st.sidebar.markdown("Dawat-e-Islami: [website](https://dawateislami.net/ur)")
